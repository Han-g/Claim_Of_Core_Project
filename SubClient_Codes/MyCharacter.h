...
private:
	...
	UPROPERTY(VisibleAnywhere, BlueprintReadOnly, Category = "Components", meta = (AllowPrivateAccess = "true"))
	UTextRenderComponent* VinePromptTextComponent;
...
private:
	...
	UPROPERTY(EditDefaultsOnly, Category = "PoisonFog")
	float PoisonFogMotionBlurAmount = 0.55f;

	UPROPERTY(EditDefaultsOnly, Category = "PoisonFog")
	float PoisonFogSceneFringeIntensity = 2.2f;

	UPROPERTY(EditDefaultsOnly, Category = "PoisonFog")
	float PoisonFogDepthOfFieldFocalDistance = 120.f;

	UPROPERTY(EditDefaultsOnly, Category = "PoisonFog")
	float PoisonFogDepthBlurAmount = 2.0f;

	UPROPERTY(EditDefaultsOnly, Category = "PoisonFog")
	float PoisonFogDepthOfFieldScale = 1.2f;
